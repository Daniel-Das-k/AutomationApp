...
class ImageGenerator:
    def __init__(self, model_id="stabilityai/stable-diffusion-2", device="cuda"):
...
class TextToVideoGenerator:
    def __init__(self, model_name="damo-vilab/text-to-video-ms-1.7b", torch_dtype=torch.float16, variant="fp16"):
    ...
    def generate_video(self, prompt, num_inference_steps=25, num_frames=100):

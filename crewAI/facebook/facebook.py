...
def facebook_login():
    print("Facebook login route accessed")
    return redirect(f"https://www.facebook.com/v12.0/dialog/oauth?client_id={Fb_APP_ID}&redirect_uri={Fb_REDIRECT_URI}&scope=email,public_profile")

...
#     uploader = YouTubeUploader(video_file_path)
#     youtube_service = uploader.get_authenticated_service()
#     try:
#         uploader.initialize_upload(youtube_service)
#     except HttpError as e:
#         print("An HTTP error %d occurred:\n%s" % (e.resp.status, e.content))

############################ updated code for video upload ###############################
import http.client as httplib
import httplib2
import os
import random
...
class YouTubeUploader:
    def __init__(self,title_description):
        self.title_descrption = title_description
        self.args = self.parse_arguments()
...
#     uploader.upload(video_file_path)
